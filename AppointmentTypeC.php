<?php
    ...
    if(isset($_POST['submitbtn'])){
        ...
        $duplicateCheckQuery = "SELECT * FROM appointment WHERE Appointment_Date = '$date' AND Start_Time = '$starttime' AND End_Time = '$endtime' AND Plan_Type = '$type'";
        ...
        if ($duplicateCheckResult->num_rows > 0) {
            ...
            $query ="INSERT INTO appointment(Unit_Plan_Type_Id, First_Name, Last_Name, Email_Address, Telephone_Number, Number_Persons, Appointment_Date, Start_Time, End_time, Plan_Type) VALUES ('3', '$firstname', '$lastname', '$email', '$number', '$numberpersons', '$date','$starttime','$endtime','$type')";
...
<body>
    ...
    <h1>UNIT PLAN TYPE C</h1>
    <div id="bookingForm">
        <div>
            <img class = "image1" src = "Type C.webp" alt="image1">
        </div>
        <div id="BB">
