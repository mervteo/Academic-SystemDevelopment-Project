<?php
  ...
  $sqlN1 = "SELECT MAX(Notice_Number) AS NN FROM public_notices"; 
  $resultN1 = $connection->query($sqlN1); 
  $NN1 = $resultN1->fetch_assoc();
  $NNN1 = $NN1['NN'] + 1;

  $sqlN2 = "SELECT MAX(Notice_Number) AS NN FROM public_notices"; 
  $resultN1 = $connection->query($sqlN1); 
  $NN1 = $resultN1->fetch_assoc();
  $NNN1 = $NN1['NN'] + 1;
  ...
  <div class="onfooter">
    <header class="header">
      <div class="header-left">
        <a href="Homepage(G).php"><img class="header-left" src="Screenshot 2023-07-07 113345.png" alt="Logo"></a>
        <a href="Homepage(G).php"><div class="header-text">ECO CITY</div></a>
      </div>
      ...
      <div class="menu">
        <ul>
          <li><a href="Login(R).php"  >Login as Resident</a></li>
          <hr>
          <li><a href="AdminLogin(A).php"  >Login as Admin</a></li>
          <hr>
          <li><a href="Appointment(G).html"  >Showroom Visit Appointment</a></li>
          <hr>
          <li><a href="Login(R).php"  >Access Card</a></li>
          <hr>
          <li><a href="Login(R).php"  >Enquiries</a></li>
          <hr>
          <li><a href="Login(R).php"  >Public Notices</a></li>
          <hr>
          <li><a href="Login(R).php"  >Payment</a></li>
          <br>
        </ul>
      </div>
    </header>
